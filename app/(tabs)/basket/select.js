...
const select = () => {
  ...
  return (
    <>
      <ScrollView>
        <View style={{ backgroundColor: "#e65100", padding: 12 }}>
          <View
            style={{
              flexDirection: "row",
              alignItems: "center",
          ...
          >
            ...
            <View
              style={{ flexDirection: "row", alignItems: "center", gap: 10 }}
            >
              <Feather name="search" size={24} color="#546e7a" />
              <Octicons name="three-bars" size={24} color="#546e7a" />
            </View>
          </View>
        </View>
        ...
        >
          <Pressable
            ...
            style={{
              ...
              borderWidth: 1,
              borderColor:
                selectedOption == "Wash + fold" ? "#546e7a" : "transparent",
            }}
          >
            <Image
          ...
          <Pressable
            ...
            style={{
              ...
              borderWidth: 1,
              borderColor:
                selectedOption == "Wash + Iron" ? "#546e7a" : "transparent",
            }}
          >
            <Image
              style={{ width: 40, height: 40 }}
          ...
          <Pressable
            ...
            style={{
              ...
              borderWidth: 1,
              borderColor:
                selectedOption == "Steam Iron" ? "#546e7a" : "transparent",
            }}
          >
            <Image
              style={{ width: 40, height: 40 }}
          ...
          <Pressable
            ...
            style={{
              ...
              borderWidth: 1,
              borderColor:
                selectedOption == "Dry Clean" ? "#546e7a" : "transparent",
            }}
          >
            <Image
              style={{ width: 40, height: 40 }}
        ...
        <View>
          ...
          >
            <Pressable
              ...
              style={{
                padding: 10,
                backgroundColor: option == "Men" ? "#546e7a" : "white",
                width: 60,
                borderRadius: 4,
              }}
            >
            ...
            <Pressable
              ...
              style={{
                ...
                backgroundColor: "white",
                width: 70,
                backgroundColor: option == "Women" ? "#546e7a" : "white",
                borderRadius: 4,
              }}
            >
              <Text
            ...
            <Pressable
              ...
              style={{
                ...
                backgroundColor: "white",
                width: 60,
                backgroundColor: option == "Kids" ? "#546e7a" : "white",
                borderRadius: 4,
              }}
            >
              <Text
            ...
            <Pressable
              ...
              style={{
                padding: 10,
                backgroundColor: "white",
                backgroundColor: option == "Houseold" ? "#546e7a" : "white",
                borderRadius: 4,
              }}
            >
              <Text
