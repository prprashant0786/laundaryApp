...
const index = () => {
  ...
  return (
    <ScrollView>
      <View style={{ padding: 12, height: 200, backgroundColor: "#e65100" }}>
        <View
          style={{
            flexDirection: "row",
            alignItems: "center",
        ...
        >
          <View>
            <Text style={{ fontSize: 13, fontFamily: "Kailasa-Bold",color:"white" }}>
              Hi,
            </Text>
            <Text style={{ fontSize: 13, fontFamily: "Kailasa-Bold",color:"white" }}>
              Welcome to the Laundary Mate
            </Text>
          </View>
      ...
      >
        ...
        >
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            <View>
              <Text
                style={{ color: "#e65100", fontSize: 15, fontWeight: "bold" }}
              >
                Club{" "}
                <Text
